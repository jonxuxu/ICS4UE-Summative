...
/**
 * Summoner.java
 * This is the character class for Summoner
 *
...
public class Summoner extends Player {
   ...
   Summoner(String username, CustomMouseAdapter myMouseAdapter) {
      super(username, myMouseAdapter);
      try {
         BufferedImage movementSheet = ImageIO.read(new File(System.getProperty("user.dir") + "/res/characters/summoner/C_summoner.png"));
