...
public class ThemedPanel extends JPanel {
  ...
  public ThemedPanel(){
    // Borders
    border1 = BorderFactory.createLineBorder(new Color(72, 60, 32), 8);
    border2 = BorderFactory.createLineBorder(new Color(141, 130, 103), 6);
    border3 = BorderFactory.createLineBorder(new Color(95, 87, 69), 8);
    border4 = BorderFactory.createLineBorder(new Color(50, 46, 41), 4);
