...
public class MobileSupport extends Player {
   ...
   MobileSupport(String username, CustomMouseAdapter myMouseAdapter) {
      super(username, myMouseAdapter);
      try {
         BufferedImage movementSheet = ImageIO.read(new File(System.getProperty("user.dir") + "/res/characters/orb/C_orb.png"));
